 ...
 * - Social links
 * - Quick navigation
 * - "Come back tomorrow" CTA to reinforce daily habit
 */

const socialLinks = [
  {
    name: 'Twitter',
    href: 'https://twitter.com/popcornguess',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/popcornguess',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Discord',
    href: 'https://discord.gg/popcornguess',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  return (
    <footer className="bg-[var(--background-secondary)] border-t border-[var(--border)]">
      {/* CTA Banner */}
      <div className="bg-gradient-to-r from-[var(--background)] via-[var(--background-tertiary)] to-[var(--background)] py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-[var(--text-muted)] mb-6 max-w-xs">
              Test your movie and TV knowledge with daily trivia quizzes.
              Build your streak, compete globally, and have fun!
            </p>
            ...
            <div className="flex gap-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="p-2 rounded-lg bg-[var(--background-tertiary)] text-[var(--text-muted)]
      ...
      <div className="border-t border-[var(--border)]">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-[var(--text-muted)]">
            <p>© {new Date().getFullYear()} PopcornGuess. All rights reserved.</p>
            <p>
              Made with <span className="text-[var(--velvet)]">❤️</span> for
              movie lovers
            </p>
          </div>
        </div>
