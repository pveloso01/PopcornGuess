...
urlpatterns = [
    # Specific paths declared BEFORE the router so they're not swallowed by
    # the QuizViewSet's `<pk>` lookup converter.
    path("quizzes/titles/", TitleAutocompleteView.as_view(), name="title-autocomplete"),
